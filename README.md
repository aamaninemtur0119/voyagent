...
| Faithfulness (LLM-judged, corpus answer vs. retrieved chunks) | the axis with the most headroom — the generation step tends to fill gaps with general knowledge (VWP membership, fee amounts, a 2026 proclamation, where to apply) the chunks don't state |
